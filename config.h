...
const int PIN_CHIP_IN_AVAILABLE_0 = 0;
const int PIN_CHIP_IN_AVAILABLE_1 = 1;
const int PIN_CHIP_IN_AVAILABLE_2 = 2;
const int PIN_CHIP_IN_AVAILABLE_3 = 3;
const int PIN_CHIP_IN_AVAILABLE_4 = 4;
...
const int PIN_CHIP_OUT_AVAILABLE_6 = 6;
const int PIN_CHIP_OUT_AVAILABLE_7 = 7;
...
const int PIN_ANALOG_AVAILABLE_7 = 7;
